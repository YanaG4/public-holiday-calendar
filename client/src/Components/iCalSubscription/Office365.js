                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>Click on “Subscribe from web”
                            <br />
                            <img src={require('../../img/outlook365/2.png')} alt="Instruction second screenshot." /></td>
                    </tr>
                    <tr>
                        <td><p>3</p></td>
                        <td>Paste the link and enter a name and click “Import”:
                            <br />
                            <img src={require('../../img/outlook365/3.png')} alt="Instruction third screenshot." /></td>
                    </tr>
                    <tr>
                        <td><p>4</p></td>
                        <td>The result would look like this:
                            <br />
                            <img src={require('../../img/outlook365/4.png')} alt="Instruction fourth screenshot." /></td>
                    </tr>
                </tbody>
            </table>
